...
# Pose definitions (same as your original code)
        ...
        <div class="control-grid">
            ...
            <div class="control">
                ...
                <div class="pose-grid">
                    ...
                    <button class="pose-btn" onclick="sendPose('smelling_ground')">👃 Smell</button>
            ...
            <div class="control">
                ...
                <div class="pose-grid">
                    ...
                    <button class="action-btn" onclick="sendAction('sit')">💺 Sit</button>
                    <button class="action-btn" onclick="sendAction('stand')">🧍 Stand</button>
                    <button class="action-btn" onclick="sendAction('greeting')">👋 Greet</button>
                </div>
            </div>
...
def initialize_robot():
    ...
    try:
        print("🤖 Initializing PiCrawler systems...")
...
def main():
    ...
    print("🕷️ PiCrawler REST API Server Starting...")
    ...
    print(f"🌐 Starting web server on {local_ip}:{port}")
    print(f"🔗 Access the control interface at: http://{local_ip}:{port}")
    print("📱 The interface is mobile-friendly and works on any device")
    print("⚡ API endpoints available:")
    print(f"   - GET  http://{local_ip}:{port}/api/status")
    print(f"   - POST http://{local_ip}:{port}/api/movement/<direction>")
    print(f"   - POST http://{local_ip}:{port}/api/pose/<pose_name>")
    print(f"   - POST http://{local_ip}:{port}/api/action/<action_name>")
    print(f"   - POST http://{local_ip}:{port}/api/speed/<speed>")
    print(f"   - POST http://{local_ip}:{port}/api/speak")
    print(f"   - POST http://{local_ip}:{port}/api/emergency_stop")
