...
class FrontRearToFSensors:
    ...
    def _initialize_hardware(self):
        ...
        try:
            ...
            print(f"✓ PCA9548A multiplexer initialized at 0x{self.mux_address:02X}")
            ...
            print(f"✓ Rear ToF initialized")
            
            self.initialized = True
            print("✓ Dual ToF sensors ready")
    ...
    try:
        ...
        while True:
            ...
            if sensors.has_front_obstacle(25):
                print("  ⚠️  Front obstacle detected!")
            if sensors.has_rear_obstacle(15):
                print("  ⚠️  Rear obstacle detected!")
